...
// Attack animations
export const BOSS3_ATTACK_ANIMATIONS: Record<string, string> = {
...
export const BOSS3_ANIMATIONS = {
  ...
  hurt: HURT_ANIMATION,
  attacks: BOSS3_ATTACK_ANIMATIONS
} as const;
